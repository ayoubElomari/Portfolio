...
export const mediumVideo = {
  ...
  variables: {
    accent: "#b98cff",
    ink: "#ffffff",
    title: "Decoded, not preprocessed",
    kicker: "rendr-web · WebCodecs, live",
    subtitle: "This footage was never baked into a file. It decodes live, right here.",

    /* The three call-outs after the title card. Not wired into `edits` in
       `page.en.mdx` — the curated set stays on the title card's own words —
       but they're ordinary variables, not literals, so they're still one
       edit away from being exposed later. */
    beat2Tag: "How",
    beat2Text:
      "Decoded through WebCodecs, one group of pictures at a time, painted straight into a canvas.",
    beat3Tag: "Honestly",
    beat3Text:
      "One 6-second clip, wrapped. What's looping is the whole source, twice, not a longer recording.",
    beat4Tag: "Also true",
    beat4Text: "Change the title, the size, the accent. Nothing here rebuilds.",
  },
