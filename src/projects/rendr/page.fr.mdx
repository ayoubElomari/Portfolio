...
<RepoCard
  ...
  note="Seule la v1.3.1, la version décrite plus haut, est publique. La v2, le moteur qui fait vraiment tourner les démos en direct sur cette page, est à code source fermé."
